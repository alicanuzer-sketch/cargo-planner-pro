...
st.caption("Endüstriyel Konteyner & Flat Rack Yük Planlama, Entegrasyon ve 3D Görselleştirme")
...
# ============================================================
# AŞAMA 2: YATAY AYARLAR & KONTROL ÇUBUĞU
# ============================================================
st.markdown("---")
ctrl1, ctrl2, ctrl3 = st.columns([2, 2, 2])

with ctrl1:
    eq_type = st.selectbox("🚛 Ekipman / Konteyner Tipi", ["40ft Flat Rack", "20ft Flat Rack", "40ft Open Top"])
...
if containers:
    ...
    for idx, placements in enumerate(containers):
        with container_tabs[idx]:
            ...
            v_tab1, v_tab2, v_tab3 = st.tabs(["🧊 Interaktif 3D Yükleme Modeli", "📐 2D Teknik Çizim Paftası", "📋 Yükleme Manifestosu & Koordinatlar"])
            
            with v_tab1:
                st.plotly_chart(render_3d_plotly(placements, dl, dw, dh), use_container_width=True, key=f"plotly_main_{idx}")
